    ...
    public static class SweSen
    {
        ...
        public static IEnumerable<string> ToLines(this string text, bool code)
        {
            ...
            for (i = 0; i < words.Length - 1; i++)
            {
                ...
                if (code)
                {
                    words[i] = codes.ContainsKey(words[i]) ? codes[words[i]] : words[i];
                }
        ...
        public static IEnumerable<string> Decode(this IEnumerable<string> lines)
        {
